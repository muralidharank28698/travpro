...
function LoginForm() {
  ...
  const d = useTranslations('Dashboard.roles');
  ...
  const handleLogin = async (e: FormEvent) => {
    ...
    try {
      ...
      setError(err.message || t('error.invalid'));
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="card p-8 space-y-6">
          ...
          <div className="pt-4 text-center border-t border-[var(--card-border)]">
            ...
            <div className="space-y-4 pt-4 border-t border-[var(--card-border)] border-dashed">
              <p className="text-[10px] font-bold text-[var(--muted-light)] uppercase tracking-widest text-center">{t('quick')}</p>
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <span className="text-xs font-bold text-[var(--foreground)]">{t('admin_role')}</span>
                ...
                >
                  ...
                  <span className="text-xs font-bold text-[var(--foreground)]">{t('user_role')}</span>
