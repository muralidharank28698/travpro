  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="flex border-b border-border/50">
        ...
        >
          {t('upcoming')}
          <span className="ml-2 inline-flex items-center justify-center bg-surface border border-border/50 text-muted text-[10px] px-2 py-0.5 rounded-full">
            {upcoming.length}
          </span>
        </button>
        <button
            ...
            <div key={booking.id} className="bg-card rounded-2xl shadow-sm border border-border/60 hover:border-border transition-all group p-5 sm:p-6 flex flex-col gap-5 relative backdrop-blur-sm">
              ...
              <div className="flex justify-between items-center border-b border-border/40 pb-4">
                <div className="flex items-center gap-3">
                  <span className={`text-[9px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full text-white ${booking.status === 'Confirmed' ? 'bg-emerald-500 shadow-sm shadow-emerald-500/20' :
