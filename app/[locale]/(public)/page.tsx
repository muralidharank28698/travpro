      ...
      <section className="py-8 lg:py-24 bg-background relative z-10 px-4 sm:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10 md:mb-16 animate-fade-in-up">
            ...
            <h2 className="text-4xl lg:text-5xl font-extrabold text-[var(--foreground)] tracking-tight">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Link href="/rentals" className="bg-card rounded-[2rem] p-4 shadow-[0_15px_40px_rgba(0,0,0,0.04)] hover:shadow-[0_25px_50px_rgba(5,150,105,0.12)] hover:-translate-y-3 transition-all duration-300 group block decoration-none text-left flex flex-col h-full animate-fade-in-up" style={{ animationDelay: "100ms" }}>
              ...
              <div className="px-4 pb-4 flex-1 flex flex-col">
                <h3 className="text-[22px] font-extrabold text-foreground mb-3">{tLanding('Services.rentals.title')}</h3>
            ...
            <Link href="/tours" className="bg-card rounded-[2rem] p-4 shadow-[0_15px_40px_rgba(0,0,0,0.04)] hover:shadow-[0_25px_50px_rgba(217,119,6,0.12)] hover:-translate-y-3 transition-all duration-300 group block decoration-none text-left flex flex-col h-full animate-fade-in-up" style={{ animationDelay: "200ms" }}>
              ...
              <div className="px-4 pb-4 flex-1 flex flex-col">
                <h3 className="text-[22px] font-extrabold text-foreground mb-3">{tLanding('Services.tours.title')}</h3>
                <p className="text-muted text-[15px] leading-relaxed mb-6 flex-1 font-medium">
            ...
            <Link href="/airport-transfers" className="bg-card rounded-[2rem] p-4 shadow-[0_15px_40px_rgba(0,0,0,0.04)] hover:shadow-[0_25px_50px_rgba(5,150,105,0.12)] hover:-translate-y-3 transition-all duration-300 group block decoration-none text-left flex flex-col h-full animate-fade-in-up" style={{ animationDelay: "300ms" }}>
              ...
              <div className="px-4 pb-4 flex-1 flex flex-col">
                <h3 className="text-[22px] font-extrabold text-foreground mb-3">{tLanding('Services.transfers.title')}</h3>
                <p className="text-muted text-[15px] leading-relaxed mb-6 flex-1 font-medium">
            ...
            <Link href="/driver-hire" className="bg-card rounded-[2rem] p-4 shadow-[0_15px_40px_rgba(0,0,0,0.04)] hover:shadow-[0_25px_50px_rgba(5,150,105,0.12)] hover:-translate-y-3 transition-all duration-300 group block decoration-none text-left flex flex-col h-full animate-fade-in-up" style={{ animationDelay: "400ms" }}>
              ...
              <div className="px-4 pb-4 flex-1 flex flex-col">
                <h3 className="text-[22px] font-extrabold text-foreground mb-3">{tLanding('Services.hire.title')}</h3>
                <p className="text-muted text-[15px] leading-relaxed mb-6 flex-1 font-medium">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            <div className="group relative rounded-[2rem] overflow-hidden shadow-[0_15px_40px_rgba(0,0,0,0.06)] hover:shadow-[0_25px_50px_rgba(0,0,0,0.12)] hover:-translate-y-2 transition-all duration-300">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-card/90 backdrop-blur-md p-6 m-4 rounded-[1.5rem]">
                ...
                <div className="flex items-center text-muted text-sm font-medium gap-2">
                  <span>📍 {tLanding('Destinations.drive', { hours: 11 })}</span>
            ...
            <div className="group relative rounded-[2rem] overflow-hidden shadow-[0_15px_40px_rgba(0,0,0,0.06)] hover:shadow-[0_25px_50px_rgba(0,0,0,0.12)] hover:-translate-y-2 transition-all duration-300">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-card/90 backdrop-blur-md p-6 m-4 rounded-[1.5rem]">
                ...
                <div className="flex items-center text-muted text-sm font-medium gap-2">
                  <span>📍 {tLanding('Destinations.drive', { hours: 10 })}</span>
                  <span className="w-1 h-1 rounded-full bg-slate-300"></span>
            ...
            <div className="absolute -bottom-8 -right-8 bg-card p-6 rounded-[2rem] shadow-2xl z-20 max-w-[200px] hidden md:block animate-[bounce_4s_infinite]">
              <div className="flex items-center gap-4 mb-2">
                ...
                <div>
                  ...
                  <div className="text-xs font-bold text-muted uppercase tracking-wider">{tLanding('WhyUs.stats.rating')}</div>
                </div>
              </div>
              <p className="text-sm text-muted font-medium">{tLanding('WhyUs.stats.trusted')}</p>
            </div>
          </div>
          ...
          <div className="space-y-10 text-white relative z-10 mt-12 lg:mt-0">
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-xl font-bold mb-1">{tLanding('WhyUs.safety.title')}</h4>
                  <p className="text-emerald-100/70 text-sm leading-relaxed">{tLanding('WhyUs.safety.description')}</p>
                </div>
              </div>
              {/* Chauffeurs */}
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-xl font-bold mb-1">{tLanding('WhyUs.chauffeurs.title')}</h4>
                  <p className="text-emerald-100/70 text-sm leading-relaxed">{tLanding('WhyUs.chauffeurs.description')}</p>
                </div>
              </div>
              {/* Reliability */}
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-xl font-bold mb-1">{tLanding('WhyUs.reliability.title')}</h4>
                  <p className="text-emerald-100/70 text-sm leading-relaxed">{tLanding('WhyUs.reliability.description')}</p>
                </div>
              </div>
            </div>
          </div>
